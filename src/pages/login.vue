...
<section class="login-page-cont">
  ...
  <div class="signup" v-if="isNewUser">
    ...
    <label class="profile-img" for="img">Profile img:
      <img src="https://res.cloudinary.com/dzuqvua7k/image/upload/v1626419180/volApp/icons/account_circle_black_24dp_meg4mh.svg">
